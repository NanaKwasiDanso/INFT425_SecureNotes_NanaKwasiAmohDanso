...
class _AuthScreenState extends State<AuthScreen> {
  ...
  Future<void> _initializeAuthState() async {
    ...
    setState(() {
      ...
      _isBiometricSupported = availableBiometrics.isNotEmpty || hasBiometrics;
  ...
  Future<void> _authenticateWithBiometrics() async {
    ...
    final authenticated = await _biometricService.authenticateWithAnyBiometric(
  ...
  Future<void> _signUp() async {
    ...
    final authenticated = await _biometricService.authenticateWithAnyBiometric(
      reason: 'Use your device biometric sensor to complete sign-up',
    );
    ...
    if (!authenticated) {
      messenger.showSnackBar(
        const SnackBar(
          content: Text(
            'Authentication failed. Please try again, enroll a biometric sensor, or use PIN only.',
          ),
        ),
      );
      return;
  ...
  String get _biometricSensorLabel {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      _hasExistingPin
                          ? 'Enter your PIN or use this device\'s biometric sensor to unlock.'
                          : 'Create a PIN and use your ${_biometricSensorLabel} to sign up.',
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (!_isBiometricSupported) ...[
                            const Text(
                              'Biometric sensor support was not detected, but you can still try authentication. If it fails, use PIN.',
                              textAlign: TextAlign.center,
                              style: TextStyle(color: Colors.white70),
                            ),
                            const SizedBox(height: 20),
